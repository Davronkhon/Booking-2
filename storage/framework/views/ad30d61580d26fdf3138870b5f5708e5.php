...
unset($__errorArgs, $__bag); ?>" id="guests" name="guests" value="<?php echo e(old('guests')); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="status" name="status" value="<?php echo e(old('status')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <select class="form-control <?php $__errorArgs = ['place_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="place_id" name="place_id" required>
                    <option value="">Выберите место</option>
                    <?php $__currentLoopData = $places; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $place): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($place->id); ?>" <?php echo e(old('place_id') == $place->id ? 'selected' : ''); ?>><?php echo e($place->name); ?></option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\Booking-1\resources\views/booking/create.blade.php ENDPATH**/ ?>